...
/*
 * CA Field Types.  When adding new types, be sure to update caTypeToArity
 * below.
 */
...
/*
 * Given a CA type, determine whether it is discrete or numeric.
 *
 *	type 		A currently valid catype
 *
 * Returns the arity type, currently only ca_arity_discrete and
 * ca_arity_numeric.
 */
function caTypeToArity(type)
{
	var t;

	switch (type) {
	case exports.ca_type_string:
	case exports.ca_type_ipaddr:
		t = exports.ca_arity_discrete;
		break;
	case exports.ca_type_latency:
	case exports.ca_type_number:
		t = exports.ca_arity_numeric;
		break;
	default:
		throw (new caError(ECA_INVAL, null, 'invalid type: "%s"',
		    type));
	}
...
exports.caTypeToArity = caTypeToArity;
