 ...
 * since we don't want to persist this configuration.  Alternatives will have to
 * be explored once we start supporting instrumentations whose idle-max values
 * will exceed the expected lifetime of a single instance of the configsvc.
 */
