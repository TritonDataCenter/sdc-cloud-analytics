...
caInstrumentationFactory.prototype.setProperties = function (inst, props,
    callback)
{
	var mutables, ii, newprops = inst.properties();
...
caInstrumentation.prototype.loadProperties = function (props)
{
	...
	for (ii = 0; ii < fields.length; ii++) {
		ASSERT(props[fields[ii]], fields[ii] + ' is present');
 ...
 * much simpler.
 */
function caInstValidateMutableFields(props)
{
	var retain;
	...
	return ([ 'enabled', 'retention-time' ]);
}

exports.caInstValidateMutableFields = caInstValidateMutableFields;
