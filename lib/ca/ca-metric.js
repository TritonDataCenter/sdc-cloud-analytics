...
/*
 * Returns the set of types that are present in this metric set as an array.
 */
caMetricSet.prototype.types = function ()
{
	var modname, statname, fieldname;
	var stats, fields, type;
	var ret = {};

	for (modname in this.cms_modules) {
		stats = this.cms_modules[modname]['stats'];
		for (statname in stats) {
			fields = stats[statname]['fields'];
