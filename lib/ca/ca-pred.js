...
var ValidationError = mod_ca.caValidationError;
 ...
 */
var keyFields = {
    lt: { numeric: true, discrete: false },
    le: { numeric: true, discrete: false },
    gt: { numeric: true, discrete: false },
    ge: { numeric: true, discrete: false },
    eq: { numeric: true, discrete: true },
    ne: { numeric: true, discrete: true }
};
...
function caPredValidateRel(inst, pred, key)
{
	...
	/*
	 * XXX We need to use the non-hardcoded values of numeric, discrete, ala
	 * INTRO 121
	 */
	...
	if (type == 'discrete' && typeof (constant) != 'string')
		throw (new ValidationError(mod_ca.caSprintf('Predicate field ' +
