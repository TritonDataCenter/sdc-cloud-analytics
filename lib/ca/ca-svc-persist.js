...
function caPersistenceService(argv, loglevel)
{
	var svc, dbg_log;
	...
	this.ps_queue = mod_cap.ca_amqp_key_base_persist +
...
caPersistenceService.prototype.routekey = function ()
{
	return (this.ps_queue);
};

caPersistenceService.prototype.start = function (callback)
{
	var svc = this;
...
caPersistenceService.prototype.cmdStatus = function (msg)
{
...
caPersistenceService.prototype.cmdDataGet = function (msg)
{
	var svc, stash, tasks;
...
caPersistenceService.prototype.cmdDataPut = function (msg)
{
	var svc, stash, tasks;
...
exports.caPersistenceService = caPersistenceService;
