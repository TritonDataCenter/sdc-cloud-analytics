...
var fname_objects = mod_path.join(srcdir, 'objects.h');
var fname_constants = mod_path.join(srcdir, 'heap-dbg-constants.h');
...
function emit_data()
{
	...
	console.log('static const int v8_nclasses = sizeof (v8_classes) / ' +
	    'sizeof (v8_classes[0]);\n');
}

function emit_class(klass)
{
	/* XXX this should really encode offsets, not assume contiguous fields */
	var fieldnames;
