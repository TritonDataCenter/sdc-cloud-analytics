...
mod_assert.deepEqual({ abe: [[[10, 20], 5 ]] },
    dataset.dataForTime(123450, 10));
mod_assert.deepEqual({}, dataset.dataForTime(123460, 10));

/* data not aligned */
dataset.update(source1, 123449, { abe: [[[10, 20], 4 ]] });
mod_assert.deepEqual({ abe: [[[10, 20], 4 ]] },
    dataset.dataForTime(123440, 10));
mod_assert.deepEqual({ abe: [[[10, 20], 5 ]] },
    dataset.dataForTime(123450, 10));
mod_assert.deepEqual({}, dataset.dataForTime(123460, 10));
...
mod_assert.deepEqual({ abe: [[[10, 20], 4 ]] },
    dataset.dataForTime(123440, 10));
mod_assert.deepEqual({ abe: [[[10, 20], 8 ]] },
    dataset.dataForTime(123450, 10));
mod_assert.deepEqual({}, dataset.dataForTime(123460, 10));
...
mod_assert.deepEqual({ abe: [[[10, 20], 4 ]] },
    dataset.dataForTime(123440, 10));
mod_assert.deepEqual({ abe: [[[10, 20], 10 ]] },
    dataset.dataForTime(123450, 10));
mod_assert.deepEqual({}, dataset.dataForTime(123460, 10));

dataset.update(source1, 123460, { abe: [[[10, 20], 10 ]] });
mod_assert.deepEqual({ abe: [[[10, 20], 4 ]] },
    dataset.dataForTime(123440, 10));
mod_assert.deepEqual({ abe: [[[10, 20], 10 ]] },
    dataset.dataForTime(123450, 10));
mod_assert.deepEqual({ abe: [[[10, 20], 10 ]] },
    dataset.dataForTime(123460, 10));
