...
mod_assert.equal(dataset.dataForTime(time1, 1), 0);
mod_assert.equal(dataset.dataForTime(time2, 1), 0);
mod_assert.equal(dataset.dataForTime(time2 + 1, 1), 0);
...
mod_assert.equal(dataset.maxreporting(time2, 1), 0);
mod_assert.equal(dataset.dataForTime(time1, 1), 10);
mod_assert.equal(dataset.dataForTime(time2, 1), 0);
...
mod_assert.equal(dataset.maxreporting(time2, 1), 0);
mod_assert.equal(dataset.dataForTime(time1, 1), 25);
mod_assert.equal(dataset.dataForTime(time2, 1), 0);
...
mod_assert.equal(dataset.dataForTime(time1, 1), 25);
mod_assert.equal(dataset.dataForTime(time2, 1), 12);
mod_assert.equal(dataset.dataForTime(time2 + 1, 1), 0);
...
mod_assert.equal(dataset.dataForTime(time1, 1), 25);
mod_assert.equal(dataset.dataForTime(time2, 1), 12);
mod_assert.equal(dataset.dataForTime(time2 + 1, 1), 15);
mod_assert.equal(dataset.dataForTime(time2 + 2, 1), 0);

/* multiple data points */
mod_assert.equal(dataset.dataForTime(time2, 2), 27);
...
mod_assert.equal(dataset.maxreporting(time2 + 1, 2), 1);
mod_assert.equal(dataset.dataForTime(time1, 1), 25);
mod_assert.equal(dataset.dataForTime(time2, 1), 27);
mod_assert.equal(dataset.dataForTime(time2 + 1, 1), 15);
...
mod_assert.equal(restored.dataForTime(time1, 1), 25);
mod_assert.equal(restored.dataForTime(time2, 1), 27);
mod_assert.equal(restored.dataForTime(time2 + 1, 1), 15);
...
mod_assert.equal(restored.maxreporting(time2 + 1, 1), 1);
mod_assert.equal(restored.dataForTime(time1, 1), 0);
mod_assert.equal(restored.dataForTime(time2, 1), 0);
mod_assert.equal(restored.dataForTime(time2 + 1, 1), 15);
...
/* initial state */
mod_assert.equal(0, dataset.dataForTime(123450, 10));

/* data properly aligned */
dataset.update(source1, 123450, 5);
mod_assert.equal(0, dataset.dataForTime(123440, 10));
mod_assert.equal(5, dataset.dataForTime(123450, 10));
mod_assert.equal(0, dataset.dataForTime(123460, 10));

/* data not aligned */
dataset.update(source1, 123449, 4);
mod_assert.equal(4, dataset.dataForTime(123440, 10));
mod_assert.equal(5, dataset.dataForTime(123450, 10));
mod_assert.equal(0, dataset.dataForTime(123460, 10));

dataset.update(source1, 123451, 3);
mod_assert.equal(4, dataset.dataForTime(123440, 10));
mod_assert.equal(8, dataset.dataForTime(123450, 10));
mod_assert.equal(0, dataset.dataForTime(123460, 10));

dataset.update(source1, 123459, 2);
mod_assert.equal(4, dataset.dataForTime(123440, 10));
mod_assert.equal(10, dataset.dataForTime(123450, 10));
mod_assert.equal(0, dataset.dataForTime(123460, 10));

dataset.update(source1, 123460, 1);
mod_assert.equal(4, dataset.dataForTime(123440, 10));
mod_assert.equal(10, dataset.dataForTime(123450, 10));
mod_assert.equal(1, dataset.dataForTime(123460, 10));
